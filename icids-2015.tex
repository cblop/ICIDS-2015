...
\mnote{Replace Allen's operators with HS}
\begin{alignat*}{3}
  &S^{1} &&\implies \mathit{initialSituation()} \land [\mathit{meets}] S^{2}\\
  &S^{2} &&\implies \mathit{interdiction()} \land [\mathit{meets}] S^{3}\\
  &S^{3} &&\implies \{S^{3}\} \land [\mathit{meets}] S^{7}\\
  &S^{3} &&\implies \langle \mathit{equals} \rangle S^{3a} \land \langle \mathit{equals} \rangle S^{3b}\\
  &S^{3b} &&\implies \mathit{violation()}\\
  &S^{3a} &&\implies [\mathit{starts}](\mathit{absentation()} \land [\mathit{during}] \{S^{3}\} \land [\mathit{meets}] S^{3a^1})\\
  &S^{3a^1} &&\implies \mathit{violation()} \land [\mathit{during}] \{S^{3}\} \land [\mathit{meets}] S^{3a^2}\\
  &S^{3a^2} &&\implies \mathit{return()} \& [\mathit{finishes}] \{S^{3}\}
\end{alignat*}
